...
interface ChannelsContextType {
  ...
  selectedPriceModelID: string | null;
  setSelectedPriceModelID: React.Dispatch<React.SetStateAction<string | null>>;
...
export default function ChannelsProvider({ children }: Props) {
  ...
  const [selectedPriceModelID, setSelectedPriceModelID] = useState<string | null>(null);
