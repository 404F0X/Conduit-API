    ...
    <div className='mb-6 w-full overflow-hidden'>
      ...
      >
        ...
        <button
          ...
          className={cn(
            'flex shrink-0 items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium whitespace-nowrap transition-[background-color,border-color,color,box-shadow]',
            selectedTab === 'all'
