  ...
  return (
    <Form {...form}>
          ...
          <div className='flex items-center justify-between'>
            <label className='flex cursor-pointer items-center space-x-3'>
              <div className='relative'>
                ...
                <div
                  className={`h-6 w-12 rounded-full border-2 transition-[border-color,background-color] duration-300 ${rememberMe ? 'border-slate-600 bg-slate-600' : 'border-slate-300 bg-slate-100'}`}
                >
                  <div
      ...
      <p className='mt-6 text-center text-sm text-slate-600'>
        ...
        <Link to='/sign-up' className='font-medium text-slate-800 underline underline-offset-4 hover:text-slate-600'>
