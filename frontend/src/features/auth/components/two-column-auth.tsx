 ...
 * Left panel: shared Conduit API brand section and diagram.
...
export default function TwoColumnAuth({
  ...
  return (
    <div className='flex min-h-screen'>
      ...
      <div className='relative hidden overflow-hidden bg-gradient-to-br from-slate-900/60 via-slate-800/40 to-slate-900/60 lg:flex lg:w-1/2'>
      ...
      <div className='relative flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 lg:w-1/2'>
        ...
        <div
          ...
          className={`relative z-10 w-full ${rightMaxWidthClassName} px-6 py-8 sm:px-8 sm:py-12`}
        >
          <Card
            className='animate-fade-in-up border-slate-200/60 bg-white/90 text-slate-800 shadow-xl shadow-slate-900/10 backdrop-blur-sm transition-[box-shadow] duration-500 hover:shadow-2xl hover:shadow-slate-900/15'
            style={
              {
