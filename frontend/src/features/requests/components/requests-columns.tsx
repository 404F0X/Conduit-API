...
import { useSecuritySettings, useUpdateSecuritySettings } from '@/features/system/data/system';
  ...
  const columns: ColumnDef<Request>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const displayedCost = costDisplay.amount(cost);

        return (
          <div className='font-mono text-xs font-medium'>
            {costDisplay.label} {displayedCost ?? '-'}
          </div>
        );
      },
    },
