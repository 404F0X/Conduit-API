...
export CONDUIT_API_KEY="${maskedApiKey}"

# Edit \${HOME}/.codex/config.toml and configure Conduit API:
model = "gpt-5"
model_provider = "conduit-responses"

[model_providers.conduit-responses]
name = "Conduit API using Chat Completions"
