...
import { getCurrencyInputAffix } from '@/lib/currency-format';
...
export const ModelPriceEditor = memo(function ChannelModelPriceEditor({
  ...
  return (
    <div className='min-w-0 space-y-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-[minmax(0,1.2fr)_minmax(9rem,1fr)_minmax(0,1fr)_auto] md:items-end'>
...
const PriceItemRow = memo(function PriceItemRow({
  ...
  const currencyPrefix = useMemo(() => {
    return getCurrencyInputAffix(currencyCode, i18n.resolvedLanguage ?? i18n.language);
  }, [currencyCode, i18n.language, i18n.resolvedLanguage]);

  return (
    <div className='min-w-0 space-y-4'>
      <div className='grid grid-cols-1 gap-x-4 gap-y-2 md:grid-cols-[minmax(0,1.2fr)_minmax(9rem,1fr)_minmax(0,1fr)_auto] md:items-start'>
